        ...
        <div>
            <nav className="navbar shadow-lg navbar-expand-lg bg-body-tertiary">
                <div className="container-fluid">
                    <Link className="navbar-brand fw-semibold text-primary ms-2 me-5" to="/">Home</Link>
                    <div className="collapse navbar-collapse" id="navbarSupportedContent">
                        <ul className="navbar-nav me-auto mb-2 mb-lg-0">
                            <li className="nav-item me-4">
                                <Link className="nav-link active" aria-current="page" to="/create-appointment">New appointment</Link>
                            </li>
                            <li className="nav-item me-4">
                        ...
                        {cookies && cookies.user &&
                            <div className="btn-group me-2 end-0">
                                ...
                                <ul className="dropdown-menu">
                                    <li><Link className="dropdown-item" to={"/client-profile/" + cookies.user.id}>Profile</Link></li>
